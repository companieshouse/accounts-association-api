...
class AssociationsListForCompanyControllerTest {
    ...
    void getAssociationsForCompanyWithNonexistentCompanyReturnsNotFound() throws Exception {
        ...
        Mockito.doReturn(true).when(transactionalService).confirmedAssociationExists("919191", "111");
    ...
    void getAssociationsForCompanyWithoutQueryParamsUsesDefaults() throws Exception {
        ...
        Mockito.doReturn(true).when(transactionalService).confirmedAssociationExists("111111", "111");
        ...
        Mockito.doReturn(associationsList).when(transactionalService).fetchUnexpiredAssociationsForCompanyAndStatuses(any(), eq(fetchAllStatusesWithout(Set.of(StatusEnum.REMOVED))),  isNull(), isNull(), eq(0), eq(15));
        ...
        Mockito.verify(transactionalService).fetchUnexpiredAssociationsForCompanyAndStatuses(eq(companyDetails) ,  eq(fetchAllStatusesWithout(Set.of(StatusEnum.REMOVED))),  isNull(), isNull(), eq(0), eq(15));
    }
    ...
    void getAssociationsForCompanySupportsRequestsFromAdminUsers() throws Exception {
        ...
        Mockito.doReturn(true).when(transactionalService).confirmedAssociationExists("MKCOMP001", "111");
        Mockito.doReturn(associationsList).when(transactionalService).fetchUnexpiredAssociationsForCompanyAndStatuses(any(), eq(fetchAllStatusesWithout(Set.of(StatusEnum.REMOVED))),  isNull(), isNull(), eq(0), eq(15));
    ...
    void getAssociationsForCompanyWithIncludeRemovedFalseAppliesFilter() throws Exception {
        ...
        final var expectedAssociationsList = new AssociationsList()
                ...
                .links(new Links().self(String.format("%s/associations", internalApiUrl)).next(""))
                .items(List.of(batmanAssociation));
        Mockito.doReturn(expectedAssociationsList).when(transactionalService).fetchUnexpiredAssociationsForCompanyAndStatuses(any(), eq(fetchAllStatusesWithout(Set.of(StatusEnum.REMOVED))), isNull(), isNull(), eq(0), eq(15));
    ...
    void getAssociationsForCompanyWithIncludeRemovedTrueDoesNotApplyFilter() throws Exception {
        ...
        Mockito.doReturn(expectedAssociationsList).when(transactionalService).fetchUnexpiredAssociationsForCompanyAndStatuses(any(), eq(fetchAllStatusesWithout(Set.of())),  isNull(), isNull(), eq(0), eq(15));
        ...
        Mockito.verify(transactionalService).fetchUnexpiredAssociationsForCompanyAndStatuses(eq(companyDetails), eq(fetchAllStatusesWithout(Set.of())),  isNull(), isNull(), eq (0), eq(15));
    }
    ...
    void getAssociationsForCompanyPaginatesCorrectly() throws Exception {
        ...
        Mockito.doReturn(expectedAssociationsList).when(transactionalService).fetchUnexpiredAssociationsForCompanyAndStatuses(any(), eq(fetchAllStatusesWithout(Set.of())),  isNull(), isNull(), eq(1), eq(1));
    ...
    void getAssociationsForCompanyDoesMappingCorrectly() throws Exception {
        ...
        final var expectedAssociationsList = new AssociationsList()
                ...
                .links(new Links().self(String.format("%s/associations", internalApiUrl)).next(""))
                .items(List.of(batmanAssociation, jokerAssociation));
        Mockito.doReturn(expectedAssociationsList).when(transactionalService).fetchUnexpiredAssociationsForCompanyAndStatuses(any(), eq(fetchAllStatusesWithout(Set.of())),  isNull(), isNull(), eq(0), eq(2));
    ...
    void getAssociationsForCompanyFetchesAssociation() throws Exception {
        ...
        Mockito.doReturn(expectedAssociationsList).when(transactionalService).fetchUnexpiredAssociationsForCompanyAndStatuses(eq(companyDetails), eq(fetchAllStatusesWithout(Set.of(StatusEnum.REMOVED))),  isNull(), isNull(), eq(0), eq(15));
    ...
    void getAssociationsForCompanyCanRetrieveMigratedAssociations() throws Exception {
        ...
        Mockito.doReturn(expectedAssociationsList).when(transactionalService).fetchUnexpiredAssociationsForCompanyAndStatuses(eq(mushroomKingdomCompany), eq(fetchAllStatusesWithout(Set.of())),  isNull(), isNull(), eq(0), eq(15));
    ...
    void getAssociationsForCompanyReturnsForbiddenWhenCalledByAUserThatIsNotAMemberOfCompanyOrAdmin() throws Exception {
        ...
        Mockito.doReturn(false).when(transactionalService).confirmedAssociationExists("111111", "MKUser001");
        mockers.mockCompanyServiceFetchCompanyProfile("111111");
    ...
    void getAssociationsForCompanyUserAndStatusWithUserIdFetchesAssociations() throws Exception {
        ...
        Mockito.doReturn(Optional.of(testDataManager.fetchAssociationDto("MKAssociation002" , user))).when(
                transactionalService).fetchUnexpiredAssociationsForCompanyUserAndStatuses(company, Set.of(CONFIRMED, REMOVED), user, "luigi@mushroom.kingdom");
    ...
    void getAssociationsForCompanyUserAndStatusWithUserEmailFetchesAssociations(final String status) throws Exception {
        ...
        Mockito.doReturn(Optional.of(testDataManager.fetchAssociationDto("MKAssociation002" , user))).when(
                transactionalService).fetchUnexpiredAssociationsForCompanyUserAndStatuses(eq(company), any(), eq(user), eq("luigi@mushroom.kingdom"));
    ...
    void getAssociationsForCompanyUserWithNonExistentUserEmailFetchesAssociations() throws Exception {
        ...
        Mockito.doReturn(Optional.of(testDataManager.fetchAssociationDto("MKAssociation001" , user))).when(
                transactionalService).fetchUnexpiredAssociationsForCompanyUserAndStatuses(company, Set.of(MIGRATED), null , "mario@mushroom.kingdom");
        final var response = mockMvc.perform(post("/associations/companies/MKCOMP001/search")
                        .header("X-Request-Id", "theId123")
                        .header("ERIC-Identity", "test")
                        .header("ERIC-Identity-Type", "key")
    ...
    void getAssociationsForCompanyNonExistentAssociationsReturnsNotFound() throws Exception {
        ...
        mockers.mockCompanyServiceFetchCompanyProfile("MKCOMP001");
        Mockito.doReturn(testDataManager.fetchUserDtos("MKUser002").getFirst()).when(usersService).retrieveUserDetails("MKUser002", null);
        Mockito.doReturn(Optional.empty()).when(transactionalService).fetchUnexpiredAssociationsForCompanyUserAndStatuses(company, Set.of(CONFIRMED, REMOVED), user, "luigi@mushroom.kingdom");
